...
summed_column :: column in summed_table being summed or a Sequel expression to be evaluated in the context of the summed_table
opts :: options hash
...
:summed_column :: column in summed_table being summed or a Sequel expression to be evaluated in the context of the summed_table, must be NOT NULL
